...
var glxconstants_1 = require("./glxconstants");
var MAX_SMALL_RENDER = 65536 - 16;
exports.glxrender = function (glx, ctx) {
    var buffers = [];
    var currentLength = 0;
    ...
    var renderContext = {
        ...
        TexImage2D: function (target, level, internalFormat, width, height, border, format, type, data) {
            render();
            var typeSize = [];
            typeSize[glxconstants_1.default.FLOAT] = 4;
            typeSize[glxconstants_1.default.BYTE] = 1;
            typeSize[glxconstants_1.default.UNSIGNED_BYTE] = 1;
            ...
            */
            ...
            switch (type) {
                case glxconstants_1.default.FLOAT:
                    for (var i = 0; i < data.length; ++i) {
                        res.writeFloatLE(data[i], 60 + i * typeSize[type]);
                    }
                    break;
                case glxconstants_1.default.BYTE:
                case glxconstants_1.default.UNSIGNED_BYTE:
                    for (var i = 0; i < data.length; ++i) {
                        res[60 + i] = data[i];
                    }
                    break;
            ...
            var maxSize = 262124;
            // @ts-ignore
            var totalRequests = 1 + parseInt(dataLen / maxSize, 10) - 1;
            if (dataLen % maxSize) {
                totalRequests++;
            }
...
//# sourceMappingURL=glxrender.js.map